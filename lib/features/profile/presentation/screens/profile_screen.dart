          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                if (_selectedIndex == 0) const PostProfileTab(),
                if (_selectedIndex == 1) const GalleryProfileTab(),
                if (_selectedIndex == 2) const FriendsProfileTab(),
                if (_selectedIndex == 3) const InfoProfileTab(),
