...
class ProductOrdersRequestTab extends StatelessWidget {
  const ProductOrdersRequestTab({super.key});
        ...
        children: <Widget>[
          ListView.separated(
            itemBuilder: (_, int index) => OrderCard(
              ...
              onAccept: () => Toast.showSuccess("Order Accepted"),
              onDecline: () => Toast.showSuccess("Order Declined"),
            ),
